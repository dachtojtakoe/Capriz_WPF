...
namespace Capriz_WPF.Database
{
    public static class DB
    {
        ...
        {
            if (!Connect("DataBase.sqlite")) return;

            var props = typeof(Data.Data).GetProperties()
                .Where(p => p.Name != "Date" && p.Name != "Time").ToArray();

            var cols = string.Join(", ", props.Select(p => $"[{p.Name}] TEXT"));
        ...
        {
            var list = DataToTable.DataToList(param);
            if (list == null || list.Count == 0) return;
            WriteDataToDB(list[0]);
        }

        static public void WriteDataToDB(Data.Data d)
        {
            try
            {
                var props = typeof(Data.Data).GetProperties()
                ...
                command = new SQLiteCommand(connection)
                {
                    CommandText = $"INSERT INTO Data (DateTime, {cols}) VALUES (@DateTime, {pars})"
                };
                command.Parameters.AddWithValue("@DateTime",
                    DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
                foreach (var p in props)
                    command.Parameters.AddWithValue("@" + p.Name,
                        (object)p.GetValue(d) ?? DBNull.Value);
                command.ExecuteNonQuery();
            }
            catch (Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(
                    "WriteDataToDB: " + ex.Message);
            }
        }
        ...
        static public void WriteDataToDBALot2(string param, int day)
        {
            var columns = param.Split('\t', '\x02', '\x03', '*');

            // Извлечение всех значений (без изменений)
            var Temperature = columns[1].Contains("/") ? "Н.Д." : columns[1];
            var Humidity = columns[2].Contains("/") ? "Н.Д." : columns[2];
            var PressureGPa = columns[3].Contains("/") ? "Н.Д." : columns[3];
            var PressureRtSt = columns[4].Contains("/") ? "Н.Д." : columns[4];
            ...
            DateTime currentTime = new DateTime(2026, 7, 20).AddDays(-92).AddDays(day);

            // Одна команда на все 144 вставки
        ...
        INSERT INTO Data (
            ...
            @Speed_10Knasalmid, @Speed_10Knasalmin, @Speed_10Knasalmax
                ...
                // Однократное добавление параметров
                command.Parameters.AddWithValue("@DateTime", "");
                command.Parameters.AddWithValue("@Temperature", "");
                command.Parameters.AddWithValue("@Humidity", "");
                command.Parameters.AddWithValue("@PressureGPa", "");
                command.Parameters.AddWithValue("@PressureRtSt", "");
                command.Parameters.AddWithValue("@BarTend", "");
                command.Parameters.AddWithValue("@Trend", "");
                command.Parameters.AddWithValue("@Speed_K", "");
                command.Parameters.AddWithValue("@Direction_K", "");
                command.Parameters.AddWithValue("@Speed_I", "");
                command.Parameters.AddWithValue("@Direction_I", "");
                command.Parameters.AddWithValue("@Direction_2Kmid", "");
                command.Parameters.AddWithValue("@Direction_2Kmin", "");
                command.Parameters.AddWithValue("@Direction_2Kmax", "");
                command.Parameters.AddWithValue("@Direction_10Kmid", "");
                command.Parameters.AddWithValue("@Direction_10Kmin", "");
                command.Parameters.AddWithValue("@Direction_10Kmax", "");
                command.Parameters.AddWithValue("@Direction_2Imid", "");
                command.Parameters.AddWithValue("@Direction_2Imin", "");
                command.Parameters.AddWithValue("@Direction_2Imax", "");
                command.Parameters.AddWithValue("@Direction_10Imid", "");
                command.Parameters.AddWithValue("@Direction_10Imin", "");
                command.Parameters.AddWithValue("@Direction_10Imax", "");
                command.Parameters.AddWithValue("@Speed_2Kmid", "");
                command.Parameters.AddWithValue("@Speed_2Kmin", "");
                command.Parameters.AddWithValue("@Speed_2Kmax", "");
                command.Parameters.AddWithValue("@Speed_10Kmid", "");
                command.Parameters.AddWithValue("@Speed_10Kmin", "");
                command.Parameters.AddWithValue("@Speed_10Kmax", "");
                command.Parameters.AddWithValue("@Speed_2Imid", "");
                command.Parameters.AddWithValue("@Speed_2Imin", "");
                command.Parameters.AddWithValue("@Speed_2Imax", "");
                command.Parameters.AddWithValue("@Speed_10Imid", "");
                command.Parameters.AddWithValue("@Speed_10Imin", "");
                command.Parameters.AddWithValue("@Speed_10Imax", "");
                command.Parameters.AddWithValue("@Visibility10", "");
                command.Parameters.AddWithValue("@Visibility1", "");
                command.Parameters.AddWithValue("@AmountPrecipitation", "");
                command.Parameters.AddWithValue("@ShipSpeed", "");
                command.Parameters.AddWithValue("@CourseShip", "");
                command.Parameters.AddWithValue("@NGO1", "");
                command.Parameters.AddWithValue("@NGO2", "");
                command.Parameters.AddWithValue("@NGO3", "");
                command.Parameters.AddWithValue("@StatusTemp1", "");
                command.Parameters.AddWithValue("@StatusTemp2", "");
                command.Parameters.AddWithValue("@StatusHum1", "");
                command.Parameters.AddWithValue("@StatusHum2", "");
                command.Parameters.AddWithValue("@StatusDirect1", "");
                command.Parameters.AddWithValue("@StatusDirect2", "");
                command.Parameters.AddWithValue("@StatusSpeed1", "");
                command.Parameters.AddWithValue("@StatusSpeed2", "");
                command.Parameters.AddWithValue("@StatusSpeedNasal", "");
                command.Parameters.AddWithValue("@StatusDirectNasal", "");
                command.Parameters.AddWithValue("@StatusPressure", "");
                command.Parameters.AddWithValue("@StatusDVGO", "");
                command.Parameters.AddWithValue("@AmountClouds", "");
                command.Parameters.AddWithValue("@StatusDMDV", "");
                command.Parameters.AddWithValue("@Temp_1mid1", "");
                command.Parameters.AddWithValue("@Hum_1mid1", "");
                command.Parameters.AddWithValue("@Hum_1mid2", "");
                command.Parameters.AddWithValue("@Temp_1mid2", "");
                command.Parameters.AddWithValue("@Speed_2K1", "");
                command.Parameters.AddWithValue("@Speed_2K2", "");
                command.Parameters.AddWithValue("@Direction_2Kmid1", "");
                command.Parameters.AddWithValue("@Direction_2Kmid2", "");
                command.Parameters.AddWithValue("@Speed_Knasal", "");
                command.Parameters.AddWithValue("@Direction_Knasal", "");
                command.Parameters.AddWithValue("@Direction_2Knasalmid", "");
                command.Parameters.AddWithValue("@Direction_2Knasalmin", "");
                command.Parameters.AddWithValue("@Direction_2Knasalmax", "");
                command.Parameters.AddWithValue("@Direction_10Knasalmid", "");
                command.Parameters.AddWithValue("@Direction_10Knasalmin", "");
                command.Parameters.AddWithValue("@Direction_10Knasalmax", "");
                command.Parameters.AddWithValue("@Speed_2Knasalmid", "");
                command.Parameters.AddWithValue("@Speed_2Knasalmin", "");
                command.Parameters.AddWithValue("@Speed_2Knasalmax", "");
                command.Parameters.AddWithValue("@Speed_10Knasalmid", "");
                command.Parameters.AddWithValue("@Speed_10Knasalmin", "");
                command.Parameters.AddWithValue("@Speed_10Knasalmax", "");

                // Транзакция на все 144 записи
                using (var transaction = connection.BeginTransaction())
                {
                    for (int i = 0; i < 144; i++)
                    {
                        command.Parameters["@DateTime"].Value = currentTime.ToString("yyyy-MM-dd HH:mm:ss");
                        command.Parameters["@Temperature"].Value = Temperature;
                        command.Parameters["@Humidity"].Value = Humidity;
                        command.Parameters["@PressureGPa"].Value = PressureGPa;
                        command.Parameters["@PressureRtSt"].Value = PressureRtSt;
                        command.Parameters["@BarTend"].Value = BarTend;
                        command.Parameters["@Trend"].Value = Trend;
                        command.Parameters["@Speed_K"].Value = Speed_K;
                        command.Parameters["@Direction_K"].Value = Direction_K;
                        command.Parameters["@Speed_I"].Value = Speed_I;
                        command.Parameters["@Direction_I"].Value = Direction_I;
                        command.Parameters["@Direction_2Kmid"].Value = Direction_2Kmid;
                        command.Parameters["@Direction_2Kmin"].Value = Direction_2Kmin;
                        command.Parameters["@Direction_2Kmax"].Value = Direction_2Kmax;
                        command.Parameters["@Direction_10Kmid"].Value = Direction_10Kmid;
                        command.Parameters["@Direction_10Kmin"].Value = Direction_10Kmin;
                        command.Parameters["@Direction_10Kmax"].Value = Direction_10Kmax;
                        command.Parameters["@Direction_2Imid"].Value = Direction_2Imid;
                        command.Parameters["@Direction_2Imin"].Value = Direction_2Imin;
                        command.Parameters["@Direction_2Imax"].Value = Direction_2Imax;
                        command.Parameters["@Direction_10Imid"].Value = Direction_10Imid;
                        command.Parameters["@Direction_10Imin"].Value = Direction_10Imin;
                        command.Parameters["@Direction_10Imax"].Value = Direction_10Imax;
                        command.Parameters["@Speed_2Kmid"].Value = Speed_2Kmid;
                        command.Parameters["@Speed_2Kmin"].Value = Speed_2Kmin;
                        command.Parameters["@Speed_2Kmax"].Value = Speed_2Kmax;
                        command.Parameters["@Speed_10Kmid"].Value = Speed_10Kmid;
                        command.Parameters["@Speed_10Kmin"].Value = Speed_10Kmin;
                        command.Parameters["@Speed_10Kmax"].Value = Speed_10Kmax;
                        command.Parameters["@Speed_2Imid"].Value = Speed_2Imid;
                        command.Parameters["@Speed_2Imin"].Value = Speed_2Imin;
                        command.Parameters["@Speed_2Imax"].Value = Speed_2Imax;
                        command.Parameters["@Speed_10Imid"].Value = Speed_10Imid;
                        command.Parameters["@Speed_10Imin"].Value = Speed_10Imin;
                        command.Parameters["@Speed_10Imax"].Value = Speed_10Imax;
                        command.Parameters["@Visibility10"].Value = Visibility10;
                        command.Parameters["@Visibility1"].Value = Visibility1;
                        command.Parameters["@AmountPrecipitation"].Value = AmountPrecipitation;
                        command.Parameters["@ShipSpeed"].Value = ShipSpeed;
                        command.Parameters["@CourseShip"].Value = CourseShip;
                        command.Parameters["@NGO1"].Value = NGO1;
                        command.Parameters["@NGO2"].Value = NGO2;
                        command.Parameters["@NGO3"].Value = NGO3;
                        command.Parameters["@StatusTemp1"].Value = StatusTemp1;
                        command.Parameters["@StatusTemp2"].Value = StatusTemp2;
                        command.Parameters["@StatusHum1"].Value = StatusHum1;
                        command.Parameters["@StatusHum2"].Value = StatusHum2;
                        command.Parameters["@StatusDirect1"].Value = StatusDirect1;
                        command.Parameters["@StatusDirect2"].Value = StatusDirect2;
                        command.Parameters["@StatusSpeed1"].Value = StatusSpeed1;
                        command.Parameters["@StatusSpeed2"].Value = StatusSpeed2;
                        command.Parameters["@StatusSpeedNasal"].Value = StatusSpeedNasal;
                        command.Parameters["@StatusDirectNasal"].Value = StatusDirectNasal;
                        command.Parameters["@StatusPressure"].Value = StatusPressure;
                        command.Parameters["@StatusDVGO"].Value = StatusDVGO;
                        command.Parameters["@AmountClouds"].Value = AmountClouds;
                        command.Parameters["@StatusDMDV"].Value = StatusDMDV;
                        command.Parameters["@Temp_1mid1"].Value = Temp_1mid1;
                        command.Parameters["@Hum_1mid1"].Value = Hum_1mid1;
                        command.Parameters["@Hum_1mid2"].Value = Hum_1mid2;
                        command.Parameters["@Temp_1mid2"].Value = Temp_1mid2;
                        command.Parameters["@Speed_2K1"].Value = Speed_2K1;
                        command.Parameters["@Speed_2K2"].Value = Speed_2K2;
                        command.Parameters["@Direction_2Kmid1"].Value = Direction_2Kmid1;
                        command.Parameters["@Direction_2Kmid2"].Value = Direction_2Kmid2;
                        command.Parameters["@Speed_Knasal"].Value = Speed_Knasal;
                        command.Parameters["@Direction_Knasal"].Value = Direction_Knasal;
                        command.Parameters["@Direction_2Knasalmid"].Value = Direction_2Knasalmid;
                        command.Parameters["@Direction_2Knasalmin"].Value = Direction_2Knasalmin;
                        command.Parameters["@Direction_2Knasalmax"].Value = Direction_2Knasalmax;
                        command.Parameters["@Direction_10Knasalmid"].Value = Direction_10Knasalmid;
                        command.Parameters["@Direction_10Knasalmin"].Value = Direction_10Knasalmin;
                        command.Parameters["@Direction_10Knasalmax"].Value = Direction_10Knasalmax;
                        command.Parameters["@Speed_2Knasalmid"].Value = Speed_2Knasalmid;
                        command.Parameters["@Speed_2Knasalmin"].Value = Speed_2Knasalmin;
                        command.Parameters["@Speed_2Knasalmax"].Value = Speed_2Knasalmax;
                        command.Parameters["@Speed_10Knasalmid"].Value = Speed_10Knasalmid;
                        command.Parameters["@Speed_10Knasalmin"].Value = Speed_10Knasalmin;
                        command.Parameters["@Speed_10Knasalmax"].Value = Speed_10Knasalmax;
